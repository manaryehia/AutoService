package com.code.autoservice.adapters;
...
import com.code.autoservice.views.activities.CarInfo;
...
public class RecyclerViewAdapter extends RecyclerView.Adapter<RecyclerViewAdapter.CarsViewHolder> {
    ...
    public RecyclerViewAdapter(Context context, List<Car> dataList ) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final RecyclerViewAdapter.CarsViewHolder holder , int i) {
        ...
        Glide.with(context).load(imageUrl2).apply(options).into(holder.imageView);
//   holder.TvTime.setText(dataList.get(i).auctionInfo.getEndDate());
    ...
    class CarsViewHolder extends RecyclerView.ViewHolder {
        ...
        private CarsViewHolder(@NonNull View itemView) {
            ...
            TvMake = itemView.findViewById(R.id.TV_MakeModel);
            TvPrice = itemView.findViewById(R.id.TV_Price);
            TvLot = itemView.findViewById(R.id.TV_lot);
            TvBid = itemView.findViewById(R.id.TV_bid);
            TvTime = itemView.findViewById(R.id.TV_timeLeft);
            imageView = itemView.findViewById(R.id.IV_CarImage);
